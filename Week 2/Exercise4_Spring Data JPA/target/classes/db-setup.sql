-- ─────────────────────────────────────────────────────────────────────────────
-- ORM Learn – Database Setup Script
...
-- Step 2 : Create the country table (matches the @Column mappings in Country.java)
...
-- Step 3 : Seed data – full world country list
--          (Hands-on 5 depends on this being populated)
DELETE FROM country;
